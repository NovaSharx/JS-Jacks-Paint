function configureListeners() {
    let images = document.getElementsByTagName('img')// select img elements  
     ...
     for (var i = 0; i < images.length; i++) {        
        ...
        document.getElementById(images[i].id).addEventListener('mouseover', (event)=> addOpacity(event))
        document.getElementById(images[i].id).addEventListener('mouseout', (event)=> removeOpacity(event))  
     }
}
